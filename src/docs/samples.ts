...
Pass the URL of your JSON file as a query parameter named "samples" in the application URL. For example: \`https://sartori.cephasteom.co.uk?samples=https://raw.githubusercontent.com/tidalcycles/dirt-samples/main/strudel.json\`.
`